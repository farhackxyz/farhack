...
| Neynar     |    The easiest way to build on Farcaster     |   [FarHack docs](https://neynar.com/blog/farhack) |
...
| XMTP | A decentralized messaging protocol |  [FarHack docs](https://xmtp.org/docs/farhack)
